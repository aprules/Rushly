...
const STATIC_SECTIONS = [
  ...
  {
    label: 'Analytics',
    description: 'Track performance and scraping activity',
    color: '#8b5cf6',
    bg: '#f5f3ff',
    cards: [
      {
        title: 'Performance',
        description: 'View live stats — leads, emails, phones, and match rates',
        icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8b5cf6" strokeWidth="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>,
        path: '/analytics', status: 'active',
      },
      {
        title: 'Scrape History',
        description: 'Log of all past scraping activity with orgs scraped and duration',
        ...
        path: '/scrape-history', status: 'active',
      }
    ]
  },
];
    ...
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: "'DM Sans', Segoe UI, sans-serif", background: '#f5f6fa' }}>
      ...
      <div style={{ marginLeft: '175px', flex: 1, padding: '32px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
          ...
          {/* Roadmap divider */}
          {(comingSoon.length > 0 || planned.length > 0) && (
            <div style={{ height: '1px', background: '#e8eaf0', margin: '4px 0' }} />
          )}
